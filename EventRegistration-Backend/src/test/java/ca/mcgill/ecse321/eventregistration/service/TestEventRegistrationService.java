...
public class TestEventRegistrationService {
	...
	@Autowired
	private EventRegistrationService erc;
	...
	public void testCreatePerson() {
		...
		List<Person> allPersons = erc.getAllPersons();
	...
	private void checkResultEvent(String name, Date eventDate, LocalTime startTime, LocalTime endTime) {
		...
		assertEquals(eventDate.toString(), erc.getAllEvents().get(0).getEventDate().toString());
